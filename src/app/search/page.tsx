...
export default function SearchPage() {
    ...
    return (
        <div className="max-w-lg pt-8 pl-4 text-gray-300">
            <h1 className="text-2xl text-white mb-6">Search</h1>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="flex mb-4">
                    <input
                        ...
                        className="w-72 bg-transparent border border-gray-800 px-3 py-1 text-white placeholder:text-gray-500 focus:outline-none"
                    />
                    <button type="submit" className="border border-gray-800 border-l-0 px-4 py-1 text-gray-300 hover:bg-[#111] hover:text-white">
                        Search
                    </button>
                </div>
                ...
                <div className="space-y-4 mb-8 text-sm">
                    ...
                    <div className="flex gap-4">
                        <span className="font-semibold text-white">Order By:</span>
                        <div className="flex gap-4">
                            <label className="flex items-center gap-1.5">
                                <input
                                    type="radio"
            ...
            <div className="mt-8">
                {results === undefined && submittedParams && <p>Loading...</p>}
